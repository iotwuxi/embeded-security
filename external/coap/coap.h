/**
 * @brief:  coap [https://github.com/exosite-garage/PicoCoAP]
*/
...
{
	CF_TEXT_PLAIN = 0,
    CF_APPLICATION_LINK_FORMAT = 40,
    CF_APPLICATION_XML = 41,
    CF_APPLICATION_OCTET_STREAM = 42,
	CF_APPLICATION_JSON = 50,
    CF_APPLICATION_CBOR = 60
} coap_content_format;
 ...
 * @see coap_version.
 */
coap_version  coap_get_version(coap_pdu *pdu);
 ...
 * @see coap_type.
 */
coap_type coap_get_type(coap_pdu *pdu);
 ...
 * @see coap_type.
 */
uint8_t coap_get_tkl(coap_pdu *pdu);
 ...
 * @see coap_code.
 */
coap_code coap_get_code(coap_pdu *pdu);
 ...
 * @see coap_get_code.
 */
uint8_t coap_get_code_class(coap_pdu *pdu);
 ...
 * @see coap_get_code.
 */
uint8_t coap_get_code_detail(coap_pdu *pdu);
 ...
 * @see mid.
 */
uint16_t coap_get_mid(coap_pdu *pdu);
